...
const AMP_GPT_REASONING_LEVELS = [
	"none",
	"minimal",
	"low",
	"medium",
				...
				<div class="max-w-xl mx-auto space-y-4 sm:space-y-6 animate-stagger">
					...
					>
						...
						<div class="space-y-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
							...
							<label class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 transition-smooth hover:border-brand-500/50 group">
								<div class="flex flex-col">
									<span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-smooth">
										Use System Proxy
									</span>
								...
								<div class="relative inline-flex h-6 w-11 items-center rounded-full transition-smooth focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2">
									<input
										type="checkbox"
										...
										class="peer sr-only"
									/>
									<div class="h-6 w-11 rounded-full bg-gray-200 dark:bg-gray-700 peer-checked:bg-brand-600 transition-smooth" />
									<div class="absolute left-1 h-4 w-4 rounded-full bg-white transition-smooth peer-checked:translate-x-5" />
								</div>
							</label>

							<Show when={!config().useSystemProxy}>
								<label class="block">
									<span class="text-sm font-medium text-gray-700 dark:text-gray-300">
										Upstream Proxy URL
									</span>
							...
							<div class="grid grid-cols-2 gap-4 mt-2">
								<label class="block">
									...
									<input
										...
										onInput={(e) =>
											handleConfigChange("proxyUsername", e.currentTarget.value)
										}
								...
								<label class="block">
									...
									<div class="relative mt-1">
										<input
											...
											placeholder="Optional"
											class="block w-full px-3 py-2 pr-10 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-smooth"
										/>
										<button
											type="button"
